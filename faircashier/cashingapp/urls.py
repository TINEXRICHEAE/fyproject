...
urlpatterns = [
    ...
    # Payment Requests
    path('api/payment-request/create/', views.create_payment_request,
         name='create_payment_request'),
    path('payment/<uuid:request_id>/', views.payment_page, name='payment_page'),
    path('payment/<uuid:request_id>/process/',
         views.process_payment, name='process_payment'),
    path('payment-item/<int:item_id>/clear/',
         views.clear_payment_item, name='clear_payment_item'),

    # Disputes
    path('dispute/file/', views.file_dispute, name='file_dispute'),
    path('dispute/<int:dispute_id>/resolve/',
         views.resolve_dispute, name='resolve_dispute'),

    # Platform Management
    path('platform/register/', views.register_platform, name='register_platform'),
    path('platform/<int:platform_id>/',
         views.platform_details, name='platform_details'),
